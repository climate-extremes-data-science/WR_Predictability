...
def regrid_file(variable,variable_ds_name,file2load,file2write,write_regridder = False, units = ""):
    ...
    if write_regridder==True:
        ...
        regridder.to_netcdf(f'/glade/work/jhayron/Data4Predictability/Regridders/regrid_{variable}.nc')
    else:
        ds_temp_1g = regrid(ds_temp,variable_ds_name,True,\
            f'/glade/work/jhayron/Data4Predictability/Regridders/regrid_{variable}.nc')
...
path_out = path_temp.replace('Daily','Daily_05Deg')
