...
def build_resnet101_model(type_pooling,do,md,activation,input_shape):
    num_classes = 5
    if activation == 'LeakyReLU':
        activation_conv= LeakyReLU()
    elif activation == 'ReLU':
...
def build_resnet50_model(type_pooling,do,md,activation,input_shape):
    num_classes = 5
    if activation == 'LeakyReLU':
        activation_conv= LeakyReLU()
    elif activation == 'ReLU':
...
def build_inception_model(type_pooling,do,md,activation,input_shape):
    num_classes = 5
    if activation == 'LeakyReLU':
        activation_conv= LeakyReLU()
    elif activation == 'ReLU':
...
def build_xception_model(type_pooling,do,md,activation,input_shape):
    num_classes = 5
    if activation == 'LeakyReLU':
        activation_conv= LeakyReLU()
    elif activation == 'ReLU':
...
def build_densenet_model(type_pooling,do,md,activation,input_shape):
    num_classes = 5
    if activation == 'LeakyReLU':
        activation_conv= LeakyReLU()
    elif activation == 'ReLU':
...
def build_mobilenet_model(type_pooling,do,md,activation,input_shape):
    num_classes = 5
    if activation == 'LeakyReLU':
        activation_conv= LeakyReLU()
    elif activation == 'ReLU':
...
def build_vgg_model(type_pooling,do,md,activation,input_shape):
    num_classes = 5
    if activation == 'LeakyReLU':
        activation_conv= LeakyReLU()
    elif activation == 'ReLU':
